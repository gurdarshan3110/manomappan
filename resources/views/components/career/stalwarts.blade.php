...
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
    @foreach($items as $stalwart)
        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <div class="p-4">
                <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ $stalwart['name'] }}</h3>
                <p class="text-gray-600 text-sm mb-4 leading-relaxed">{{ $stalwart['description'] }}</p>
                ...
                @if(!empty($stalwart['instagram_link']) || !empty($stalwart['facebook_link']) || !empty($stalwart['x_link']) || !empty($stalwart['linkedin_link']))
                    <div class="flex space-x-3">
                        @if(!empty($stalwart['instagram_link']))
                            <a href="{{ $stalwart['instagram_link'] }}" 
                               target="_blank" 
