                    ...
                    <div class="col-lg-12 text-center">
                     ...
                     <table class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <th class="table-heading" valign="top">
                                <table width="100%" valign="top">
                                  <tr>
                                    <td class="p-0"><h3>Career Compass</h3></td>
                                    <td class="p-0 text-end" width="50%"><img src="images/compass3.png" alt="Compass"></td>
                                  </tr>
                                </table>
                              </th>
                              <th  class="table-heading" >
                                <table width="100%" class="" >
                                  <tr>
                                    <td class="p-0"><h3>Career Navigator</h3></td>
                                    <td class="p-0 text-end" width="50%"><img src="images/nav2.png" alt="Navigator"></td>
                                  </tr>
                                </table>
                              </th>
                          </tr>
                        ...
                        <tbody>
                          <tr>
                            <td>Price</td>
                            <td class="price-text">₹ 999</td>
                            <td class="price-text">₹ 1799</td>
                          </tr>
                          <tr>
                            <td class="p-0" valign="middle">Buy Plan</td>
                            <td class="p-0 bg-transparent"><a href="payment.html" class="btn btn-light w-100">Buy Now</a></td>
                            <td class="p-0 bg-transparent"><a href="payment.html" class="btn btn-dark w-100">Buy Now</a></td>
                          </tr>
                          <tr>
                            <td>Counsellor</td>
                            <td>Career guidance to uncover biases and map career path</td>
                            <td>Career guidance to uncover biases and map career path</td>
                          </tr>
                          <tr>
                            <td>Language</td>
                            <td>Aptitude, Aptitude and Personality Profile to guide your career</td>
                            <td>Aptitude, Aptitude and Personality Assessments</td>
                          </tr>

                          <tr>
                            <td>Report</td>
                            <td>Immediate Career Profiling Report</td>
                            <td>Immediate Career Profiling Report</td>
                          </tr>

                          <tr>
                            <td>AI drive career support</td>
                            <td>AI driven Digital Career Library</td>
                            <td>AI driven Digital Career Library</td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td></td>
                            <td>Expert Career Counseling Session by Career Psychologist *
                                <span class="d-block"><img src="images/men-icon1.png"></span>
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td></td>
                            <td>Interaction with your career role model and include parents in disucssion
                                <span class="d-block"><img src="images/men-icon2.png"></span>
                            </td>
                          </tr>
                          <tr>
          ...
          <div class="col-12">
            <div class="career-compass-card">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <img src="images/compass3.png" alt="Compass">
              </div>
              <p>Uncover career biases and map your career path with aptitude and personality profiling. Get an instant career report and explore AI-driven career options in Gujarati, Hindi, or English.</p>
              <div class="career-compass-price">
                <h4>₹ 999</h4>
                <a href="payment.html" class="btn btn-dark w-100">Buy Now</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-12">
            <div class="career-compass-card">
              <div class="d-flex justify-content-between align-items-center">
                ...
                <img src="images/nav2.png" alt="Compass">
              </div>
              <p>Uncover career biases and map your career path with aptitude and personality profiling. Get an instant career report and explore AI-driven career options in Gujarati, Hindi, or English.</p>
              <div class="career-text">
                <span class="d-block"><img src="images/men-icon1.png"></span>
                <p>Expert Career Counseling Session by Career Psychologist</p>
              </div>

              <div class="career-text">
                <span class="d-block"><img src="images/men-icon2.png"></span>
                <p>Interaction with your career role model and include parents in disucssion</p>
              </div>
              <div class="career-compass-price">
                <h4>₹ 1799</h4>
                <a href="payment.html" class="btn btn-dark w-100">Buy Now</a>
